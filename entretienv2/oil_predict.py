...
url_recup = 'http://localhost:8080/api/plugins/telemetry/DEVICE/4f5afac0-70a5-11ec-a326-4345504f184b/values/timeseries?keys=kilometrage&startTs=' + str(date_derniere_vidange) + "000" + '&endTs=' + str(today) + '000' + '&agg=NONE'
...
url_recup = 'http://localhost:8080/api/plugins/telemetry/DEVICE/4f5afac0-70a5-11ec-a326-4345504f184b/values/timeseries?keys=oil&startTs=' + str(date_derniere_vidange) + "000" + '&endTs=' + str(today) + '000' + '&agg=NONE'
